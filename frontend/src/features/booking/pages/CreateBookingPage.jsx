...
function CreateBookingPage() {
  ...
  const [formData, setFormData] = useState({
    resourceId: "1", // Hardcoded default to workaround missing Module A fetch
    bookingDate: "",
    startTime: "",
    endTime: "",
    purpose: "",
      ...
      <div className="card" style={{ maxWidth: "600px", width: "100%", margin: "0 auto" }}>
        ...
        <form onSubmit={handleSubmit} className="form-grid">
          <div className="input-group">
            <label>Resource (Temporary Mock)</label>
            <select
              className="input"
              name="resourceId"
              ...
              required
            >
              <option value="1">Main Lecture Hall (ID: 1)</option>
              <option value="2">Computer Lab A (ID: 2)</option>
              <option value="3">Discussion Room 101 (ID: 3)</option>
            </select>
          </div>
